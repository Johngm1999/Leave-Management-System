...
if(isset($_POST['submit'])){
	...
	if($id>0){
		...
		$sql="insert into employee(name,email,mobile,password,department_id,address,birthday,role,image,designation) values('$name','$email','$mobile','$password','$department_id','$address','$birthday','6','$image','$designation')";
	}
	move_uploaded_file($tempname,$folder);
	mysqli_query($con,$sql);
	header('location:non_employee.php');
	die();
}
?>
