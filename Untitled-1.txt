...
break;
case '2':$res=mysqli_query($con,"select * from employee where department_id=2 and role=2 order by id desc");
break;
case '3':$res=mysqli_query($con,"select * from employee where department_id=3 and role=2 order by id desc");
break;
