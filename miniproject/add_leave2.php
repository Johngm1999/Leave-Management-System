                        ...
                        <div class="card-body">
						   ...
						   <h4 class="box_title_link"><a href="hod_leave.php">Add Leave</a> </h4>
							...
							<?php }elseif($_SESSION['ROLE']==3){ ?>
							 ...
							 <h4 class="box_title_link"><a href="leave.php">Teaching Staff Leave approval</a> </h4>
							 <h4 class="box_title_link"><a href="leave1.php">Non Teaching Staff Leave approval</a> </h4>
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <?php
									   if($row['leave_status']==1){?>
									   <a href="add_leave2.php?id=<?php echo $row['id']?>">Delete</a></td>
                                    </tr>
									   <?php } ?>
