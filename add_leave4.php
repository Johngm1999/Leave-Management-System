...
if(isset($_GET['type']) && $_GET['type']=='update' && isset($_GET['id'])){
	...
	mysqli_query($con,"update `hod_leave` set hod_leave='$status' where id='$id'");
}
if(($_SESSION['ROLE']==1) && ($_SESSION['DEPARTMENT_ID'])){ 
	$sql="select `hod_leave`.*, employee.name,employee.role=6  as eid  from `hod_leave`,employee where `hod_leave`.employee_id=employee.id order by `hod_leave`.id desc";
}else{
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
						   ...
						   <h4 class="box_title_link"><a href="hod_leave.php">Apply Leave</a> </h4>
